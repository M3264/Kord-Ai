...
createCmd("typography", "https://en.ephoto360.com/create-online-typography-art-effects-with-multiple-layers-811.html", "✨", "typography text effect", {
    needsMultipleTexts: false,
    numTexts: 1
});

createCmd("wetglass", "https://en.ephoto360.com/write-text-on-wet-glass-online-589.html", "💧", "wet glass text effect", {
    needsMultipleTexts: false,
    numTexts: 1
});

createCmd("light", "https://en.ephoto360.com/light-text-effect-futuristic-technology-style-648.html", "🤖", "futuristic technology text effect", {
    hasRadio: true,
    radioName: "radio0",
    radioOptions: [
...
createCmd("pubgtext", "https://en.ephoto360.com/pubg-mascot-logo-maker-for-an-esports-team-612.html", "🎮", "PUBG mascot logo", { needsMultipleTexts: true, numTexts: 2 });

createCmd("pubglogo", "https://en.ephoto360.com/pubg-logo-maker-cute-character-online-617.html", "🎮", "PUBG logo with cute character", {
    hasRadio: true,
    radioName: "radio0",
    radioOptions: [
...
createCmd("valorant", "https://en.ephoto360.com/create-valorant-banner-youtube-online-588.html", "🎮", "Valorant YouTube banner", {
  ...
  {
    "name": "radio0[radio]",
    "value": "882898c0-054d-450a-bbc1-f5671d77c8a7",
    "dataTitle": "Killjoy"
  },
  {
    "name": "radio0[radio]",
  ...
  {
    "name": "radio0[radio]",
    "value": "48ab2129-3543-4fa9-ad1e-1eb8792dfad6",
    "dataTitle": "Viper"
  },
    ]
});

createCmd("codtext", "https://en.ephoto360.com/create-call-of-duty-warzone-youtube-banner-online-548.html", "🎮", "Call of Duty Warzone YouTube banner", {
    needsMultipleTexts: true,
    numTexts: 2,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("lolwlp", "https://en.ephoto360.com/make-your-own-league-of-legends-wallpaper-full-hd-442.html", "🎮", "League of Legends wallpaper", {
    needsMultipleTexts: false,
    numTexts: 1,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("amongus", "https://en.ephoto360.com/create-a-banner-game-among-us-with-your-name-763.html", "🎮", "Among Us avatar banner", {
    needsMultipleTexts: true,
    numTexts: 2
});

createCmd("angel", "https://en.ephoto360.com/create-colorful-angel-wing-avatars-731.html", "👼", "angel wing avatar", {
    needsMultipleTexts: false,
    numTexts: 1,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("green", "https://en.ephoto360.com/green-brush-text-effect-typography-maker-online-153.html", "🖌️", "green brush text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("neontext", "https://en.ephoto360.com/neon-text-effect-online-78.html", "💡", "neon text effect", {
    needsMultipleTexts: true,
    numTexts: 2
});

createCmd("glow", "https://en.ephoto360.com/create-multicolored-neon-light-signatures-591.html", "✨", "multicolored neon light signature", {
    hasRadio: true,
    radioName: "radio0",
    radioOptions: [
...
createCmd("lightb", "https://en.ephoto360.com/create-realistic-vintage-3d-light-bulb-608.html", "💡", "realistic 3D light bulb", {
    needsMultipleTexts: true,
    numTexts: 2
});

createCmd("glitter", "https://en.ephoto360.com/free-glitter-text-effect-maker-online-656.html", "✨", "glitter text effect", {
    needsMultipleTexts: true,
    numTexts: 2,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("watercolor", "https://en.ephoto360.com/create-a-watercolor-text-effect-online-655.html", "🎨", "watercolor text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("paper", "https://en.ephoto360.com/multicolor-3d-paper-cut-style-text-effect-658.html", "✂️", "3D paper cut text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("glitch", "https://en.ephoto360.com/tik-tok-text-effects-online-generator-485.html", "📹", "TikTok text effect", {
    needsMultipleTexts: true,
    numTexts: 2
});

createCmd("metal", "https://en.ephoto360.com/metal-mascots-logo-maker-486.html", "🏆", "metal mascot logo", {
    hasRadio: true,
    radioName: "radio0",
    radioOptions: [
...
createCmd("galaxy", "https://en.ephoto360.com/making-neon-light-text-effect-with-galaxy-style-521.html", "🌌", "galaxy neon light text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("blue", "https://en.ephoto360.com/create-blue-neon-logo-online-507.html", "💙", "blue neon logo", {
    hasRadio: true,
    radioName: "radio0",
    radioOptions: [
...
createCmd("galaxyw", "https://en.ephoto360.com/create-galaxy-wallpaper-mobile-online-528.html", "🌌", "galaxy wallpaper", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("glossy", "https://en.ephoto360.com/glossy-chrome-text-effect-online-424.html", "🤖", "glossy chrome text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("glass2", "https://en.ephoto360.com/write-text-on-wet-glass-online-589.html", "💧", "wet glass text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("glow2", "https://en.ephoto360.com/advanced-glow-effects-74.html", "✨", "advanced glow text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("wood", "https://en.ephoto360.com/wooden-3d-text-effect-59.html", "🌳", "3D wooden text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("slight", "https://en.ephoto360.com/create-sunset-light-text-effects-online-807.html", "🌆", "sunset light text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("sketch", "https://en.ephoto360.com/create-a-pencil-sketch-logo-online-719.html", "✏️", "pencil sketch logo", {
    needsMultipleTexts: true,
    numTexts: 2,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("zodiac", "https://en.ephoto360.com/create-star-zodiac-wallpaper-mobile-online-604.html", "🌟", "star zodiac wallpaper", {
    hasRadio: true,
    radioName: "radio0",
    radioOptions: [
...
createCmd("floral", "https://en.ephoto360.com/floral-luxury-logo-collection-for-branding-616.html", "🌺", "floral luxury logo", {
    needsMultipleTexts: true,
    numTexts: 2,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("hacker", "https://en.ephoto360.com/create-anonymous-hacker-avatars-cyan-neon-677.html", "🕵️", "hacker neon avatar", {
    needsMultipleTexts: false,
    numTexts: 1,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("neondvl", "https://en.ephoto360.com/neon-devil-wings-text-effect-online-683.html", "😈", "neon devil wings text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("crack", "https://en.ephoto360.com/create-3d-crack-text-effect-online-704.html", "💥", "3D crack text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("scifi", "https://en.ephoto360.com/create-a-awesome-logo-sci-fi-effects-492.html", "🤖", "sci-fi logo", {
    needsMultipleTexts: true,
    numTexts: 3
});

createCmd("sand", "https://en.ephoto360.com/create-a-summery-sand-writing-text-effect-577.html", "🏖️", "sand writing text effect", {
    needsMultipleTexts: false,
    numTexts: 1,
});

createCmd("letter", "https://en.ephoto360.com/create-letter-logos-online-for-free-545.html", "🔤", "letter logo", {
    needsMultipleTexts: true,
    numTexts: 2,
    hasRadio: true,
    radioName: "radio0",
...
createCmd("gaming", "https://en.ephoto360.com/create-a-gaming-mascot-logo-free-560.html", "🎮", "gaming mascot logo", {
    needsMultipleTexts: false,
    numTexts: 1,
    hasRadio: true,
    radioName: "radio0",
