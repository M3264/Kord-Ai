...
module.exports = {
    usage: ["neon"],
    desc: "Generates a neon-style image from the provided text using the Ephoto360 API.",
    ...
    async execute(sock, m, args) {
        try {
            ...
            const apiUrl = `https://api.giftedtechnexus.co.ke/api/ephoto360/makingneon?text=${encodedText}&apikey=${apiKey}`;
            ...
            const caption = "Here is your neon-style image!";
